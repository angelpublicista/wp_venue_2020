...
/*============= INFO CONTACT ================*/
include "mt_options/mt-info-contact.php";

/*============= SOCIAL SHAPES ================*/
include "mt_options/mt-social-shapes.php";

/*============= GENERAL OPTIONS ================*/
include "mt_options/mt-general-options.php";

/*============= HEADER ================*/
include "mt_options/mt-header.php";

/*============= POPUP ================*/  
include "mt_options/mt-popup.php";

/*============= BLOG ================*/
include "mt_options/mt-blog.php";

/*============= WOOCOMMERCE ================*/
include "mt_options/mt-woocommerce.php";

/*============= FOOTER ================*/
include "mt_options/mt-footer.php";

/*============= RESPONSIVE OPTIONS ================*/
include "mt_options/mt-responsive.php";
